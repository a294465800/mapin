...
let api = {
  ...
  //获取核销码
  getConfirmQRCode(data, callback) {
    _http.get(`${host}CreateCheckCode.aspx`, data)
      .then(res => {
        typeof callback === 'function' && callback(res)
      })
      .catch(err => {
  ...
  //单纯获取用户信息
  getPureUserInfo(data, callback) {
    _http.get(`${host}UserGet.aspx`, data)
      .then(res => {
        typeof callback === 'function' && callback(res)
      })
      .catch(err => {
  ...
  //获取可提现金额
  getMoney(data, callback) {
    _http.post(`${host_upload}pay/ShopIncome.aspx`, data)
      .then(res => {
        typeof callback === 'function' && callback(res)
      })
      .catch(err => {
